...
import { loginOk, loginErr } from "../../features/employeeSlice";
...
export default function TeamLeaderLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/auth/employee", {
        method: "POST",
        headers: {
      ...
      <div className="w-full lg:w-2/5 flex items-center justify-center bg-gray-100 p-8">
        <div className="w-full max-w-md">
          <h2 className="text-2xl font-bold mb-6 text-center text-black">
            <span className="text-blue-500 font-semibold text-4xl">Welcome,</span> Skar Employee
          </h2>
