...
const TeamLeadProfile = () => {
  ...
  useEffect(() => {
    if (teamleadId) {
      axios
        .get(`http://localhost:5000/api/teamlead/${teamleadId}`)
        .then((response) => {
        ...
        .catch((error) => {
          setError("Failed to fetch team lead details.");
          setLoading(false);
        });
    }
  }, [teamleadId]);
  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      <h2 className="text-2xl font-semibold text-center bg-blue-400 text-white p-2 mb-8">Team Lead Profile</h2>
